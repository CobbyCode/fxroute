...
def _lifespan_patches(slow_player, slow_effects):
    return [
        ...
        mock.patch.object(main.external_input, "sync", mock.AsyncMock(side_effect=lambda overview: overview)),
        mock.patch.object(main.bluetooth_input, "sync", mock.AsyncMock(side_effect=lambda overview: overview)),
        mock.patch.object(main.bluetooth_input, "run_monitor_loop", _done_loop),
        mock.patch.object(main.spotify_playerctl_watch, "run_watch_loop", _done_loop),

...
const cases = [
    ...
    [{ codec: 'AAC', bitrate_kbps: 320, samplerate_hz: 44100 }, 'AAC · 320kbps · 44.1kHz'],
    // live Radio Paradise flac: the Lossless label and the content-dependent
    // bitrate are redundant for lossless codecs
    [{ codec: 'FLAC', profile: 'Lossless', bitrate_kbps: 746, samplerate_hz: 44100 }, 'FLAC · 44.1kHz'],
    // live FIP midfi mp3 (48 kHz!)
    [{ codec: 'MP3', bitrate_kbps: 128, samplerate_hz: 48000 }, 'MP3 · 128kbps · 48kHz'],
    // live SomaFM 256 mp3
    [{ codec: 'MP3', bitrate_kbps: 256, samplerate_hz: 44100 }, 'MP3 · 256kbps · 44.1kHz'],
    // live KEXP 160 aac (measured 2026-08-02)
    [{ codec: 'AAC', bitrate_kbps: 161, samplerate_hz: 44100 }, 'AAC · 161kbps · 44.1kHz'],
    // bitrate not delivered yet: known parts stay, no empty separators
    [{ codec: 'AAC', samplerate_hz: 44100 }, 'AAC · 44.1kHz'],
    // profile only, no samplerate
    [{ codec: 'AAC', profile: 'Low' }, 'AAC · Low'],
    // local FLAC 24 bit (decoded format s32)
    [{ codec: 'FLAC', profile: 'Lossless', bit_depth: 24, samplerate_hz: 44100 }, 'FLAC · 24bit · 44.1kHz'],
    // local FLAC 16 bit
    [{ codec: 'FLAC', profile: 'Lossless', bit_depth: 16, samplerate_hz: 44100 }, 'FLAC · 16bit · 44.1kHz'],
    // local WAV 24 bit: lossless, no redundant bitrate/profile
    [{ codec: 'PCM', bitrate_kbps: 1058, bit_depth: 24, samplerate_hz: 44100 }, 'PCM · 24bit · 44.1kHz'],
    // lossless codec without extra facts
    [{ codec: 'FLAC', profile: 'Lossless' }, 'FLAC'],
    // lossless ALAC hi-res
    [{ codec: 'ALAC', profile: 'Lossless', bit_depth: 24, samplerate_hz: 88200 }, 'ALAC · 24bit · 88.2kHz'],
    // local lossy: no bit depth (floatp decode)
    [{ codec: 'MP3', bitrate_kbps: 320, samplerate_hz: 44100 }, 'MP3 · 320kbps · 44.1kHz'],

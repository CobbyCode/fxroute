...
class AutoSubTargetCurveSnapshotTests(unittest.TestCase):
    def validate(self, payload):
        return autosub_scoring._validate_auto_sub_target_curve_snapshot(json.dumps(payload))
    ...
    def test_invalid_or_missing_points_are_rejected_without_neutral(self):
        ...
        for raw in invalid:
            with self.subTest(raw=raw):
                snapshot, error = autosub_scoring._validate_auto_sub_target_curve_snapshot(raw)
    ...
    def test_display_offset_cannot_mutate_target_or_raw_reference_points(self):
        ...
        autosub_scoring._auto_sub_measurement_from_sweep(raw, "Before", "AutoSub Before")

...
"""Build the second FXRoute demo music library, presented in the web demo
as "NAS Library 1" (the "Demo Library 2" share).
...
def build_playlists(manifest_albums: list[dict]) -> list[dict]:
    ...
    seeds = [
        ...
        ("playlist_d2_sampler", "NAS Library 1 Sampler",
...
def build(src_dir: Path, out_dir: Path, pool_dir: Path | None) -> dict:
    manifest: dict = {"library": "NAS Library 1", "albums": []}
    total_tracks = 0
...
JS_PREAMBLE = """// NAS Library 1 catalog fixture (generated by scripts/build_demo_library2.py --webdemo-js).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the NAS Library 1 demo music share.")

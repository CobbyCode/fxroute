...
class MeasurementStore:
    ...
    def get_calibration_file_for_export(self, calibration_ref: str) -> tuple[Path, str]:
        return self._get_managed_file_for_export(
            self.calibrations_dir,
            calibration_ref,
            self._display_calibration_filename,
        )
    ...
    def get_house_curve_file_for_export(self, house_curve_ref: str) -> tuple[Path, str]:
        return self._get_managed_file_for_export(
            self.house_curves_dir,
            house_curve_ref,
            self._stored_house_curve_filename,
        )
    ...
    def _repeat_delegate(self, name: str, *args, **kwargs):
        return getattr(self._repeat_runner, name)(*args, **kwargs)

...
SWEEP_TIMING_ANCHOR_LAYOUT = (
    ("start-inner", 0.06), ("start-body", 0.18), ("mid-low", 0.38),
    ("mid-high", 0.62), ("end-body", 0.82), ("end-inner", 0.94),
)
...
IR_DEBUG_SEGMENT_RADIUS_SAMPLES = _env_int("FXROUTE_MEASUREMENT_IR_DEBUG_SEGMENT_RADIUS_SAMPLES", 250, minimum=64, maximum=5000)
